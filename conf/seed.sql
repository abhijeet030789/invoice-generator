DELETE from Firm where gstNo in ('F2', 'F3', 'F4');

INSERT INTO Firm (gstNo, firmName, addressLineOne, state, stateCode, phoneNumber, emailId, bankName, accountNumber, ifscCode, bankBranch) VALUES('F2', 'Firm2', 'Firm2-Address', 'West Bengal', '19', '88888', 'F1@F1.com', 'AXIS BANK', '12456789F2', 'UTI116549F2', 'Burrabazar');
INSERT INTO Firm (gstNo, firmName, addressLineOne, state, stateCode, phoneNumber, emailId, bankName, accountNumber, ifscCode, bankBranch) VALUES('F3', 'Firm3', 'Firm3-Address', 'West Bengal', '19', '88888', 'F1@F1.com', 'AXIS BANK', '12456789F3', 'UTI116549F3', 'Burrabazar');
INSERT INTO Firm (gstNo, firmName, addressLineOne, state, stateCode, phoneNumber, emailId, bankName, accountNumber, ifscCode, bankBranch) VALUES('F4', 'Firm4', 'Firm4-Address', 'Karnataka', '25', '88888', 'F1@F1.com', 'AXIS BANK', '12456789F4', 'UTI116549F4', 'Burrabazar');
